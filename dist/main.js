...
const renderProject = (projectObject) => {
    ...
    const renderData = () => {
        ...
        const deadline = () => {
            ...
            deadline.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(proj.getDeadline(), "MM.dd.yyyy");
...
const renderTask = (task) => {
    ...
    deadline.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.getDeadline(), "MM.dd.yyyy");
    deadlineContent.appendChild(deadline);
...
/* harmony import */ var _example_task_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./example-task.json */ "./src/example-task.json");
...
const createToDo = (title = _example_task_json__WEBPACK_IMPORTED_MODULE_1__.title, deadline = _example_task_json__WEBPACK_IMPORTED_MODULE_1__.deadline, priority = _example_task_json__WEBPACK_IMPORTED_MODULE_1__.priority, description = _example_task_json__WEBPACK_IMPORTED_MODULE_1__.description, goal = _example_task_json__WEBPACK_IMPORTED_MODULE_1__.goal) => {
...
module.exports = JSON.parse('{"title":"My Task","description":"Describe task here.","priority":2,"goal":"Create three projects.","deadline":"8/12/2022"}');

/***/ }),

/***/ "./src/example-task.json":
/*!*******************************!*\
  !*** ./src/example-task.json ***!
  \*******************************/
/***/ ((module) => {

module.exports = JSON.parse('{"title":"Complete project module","description":"Create project generation module for ToDo project","priority":1,"goal":"Project factory returns completed object","deadline":"7/24/2022"}');
...
const test2 = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)("Seocnd Task", destDate, 1, "Nothin rly")
...
(0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderTask)((0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)());
...
(0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderProject)((0,_project__WEBPACK_IMPORTED_MODULE_2__.Project)());
