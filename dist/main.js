...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --greyBlue: rgb(156, 164, 199);\n    --happyBlue: rgb(126, 150, 228);\n    --bg-color: var(--happyBlue, blue);\n\n    --low-priority: rgb(162, 178, 233);\n    --med-priority: rgb(162, 178, 233);\n}\n\nbody{\n    background-color:var(--bg-color, blue)\n}\n\n.test{\n    background-color: rgba(243, 238, 210, 0.918);\n    height: 200px;\n    width: 200px;\n    display: fixed;\n    justify-content: center;\n    align-items: center;\n    display: flex;\n    border-radius: 10px 10px 5px 5px;\n}\n\n.sub{\n    \n    height: 50%;\n    width: 50%;\n    background-color: rgba(8, 199, 24, 0.76);\n    border-radius: 50%;\n}\n\n.task {\n    height: 200px;\n    width: 200px;\n\n    background-color: peachpuff;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,8BAA8B;IAC9B,+BAA+B;IAC/B,kCAAkC;;IAElC,kCAAkC;IAClC,kCAAkC;AACtC;;AAEA;IACI;AACJ;;AAEA;IACI,4CAA4C;IAC5C,aAAa;IACb,YAAY;IACZ,cAAc;IACd,uBAAuB;IACvB,mBAAmB;IACnB,aAAa;IACb,gCAAgC;AACpC;;AAEA;;IAEI,WAAW;IACX,UAAU;IACV,wCAAwC;IACxC,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,YAAY;;IAEZ,2BAA2B;AAC/B","sourcesContent":[":root{\n    --greyBlue: rgb(156, 164, 199);\n    --happyBlue: rgb(126, 150, 228);\n    --bg-color: var(--happyBlue, blue);\n\n    --low-priority: rgb(162, 178, 233);\n    --med-priority: rgb(162, 178, 233);\n}\n\nbody{\n    background-color:var(--bg-color, blue)\n}\n\n.test{\n    background-color: rgba(243, 238, 210, 0.918);\n    height: 200px;\n    width: 200px;\n    display: fixed;\n    justify-content: center;\n    align-items: center;\n    display: flex;\n    border-radius: 10px 10px 5px 5px;\n}\n\n.sub{\n    \n    height: 50%;\n    width: 50%;\n    background-color: rgba(8, 199, 24, 0.76);\n    border-radius: 50%;\n}\n\n.task {\n    height: 200px;\n    width: 200px;\n\n    background-color: peachpuff;\n}"],"sourceRoot":""}]);
// Exports
...
const renderProject = (proj) => {
    ...
    const project = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "project", id: `${proj.title}-id`})
    
    // attributes
    const title = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('h2', {'class': "project-title"});
    title.textContent = proj.title;
   
    const description = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "project-desc", 'id': `${proj.title}-desc`});
    description.textContent = proj.description;
    
    const priority = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "project-priority", "id": `${proj.title}-priority`});
    priority.textContent = proj.priority;
    
    const goal = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "project-goal", "id": `${proj.title}-goal`});
    goal.textContent = proj.goal;
    
    const deadline = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "project-deadline", "id": `${proj.deadline}-deadline`});
...
content.appendChild((0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderTask)(test2))
content.appendChild((0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderTask)((0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)("Dynamic!", "07/30/22", 2, "Descripto Chjange")))
