...
const renderProject = (projectObject) => {
    ...
    const renderData = () => {
        ...
        const deadline = () => {
            ...
            deadline.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(proj.getDeadline(), "MM.dd.yyyy");
    ...
    const tasks = () => {
        ...
        const sample = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div');
    ...
    const projectButtons = () => {
        ...
        const buttonContainer = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': 'button-bar'});

        // Will replace with image
        const closeProject = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'id': 'close-project', 'value': 'Close'});
        const editProject = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'id': 'edit-project', 'value': 'Edit'})
...
const editTitle = () => {
    ...
    const editTitleBox = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('textarea',  {'name': 'textarea', 'placeholder': title.innerText, "class": 'edit-proj-box project-title project-item'});
...
const editProjectDescription = () => {
    ...
    const editDescriptionBox = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('textarea', {'name':'textarea', 'placeholder': desc.innerText, 'class': 'edit-proj-box project-item project-desc'});
...
const editProjectGoal = () => {
    ...
    const editGoalBox = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('textarea', {'placeholder': goalText, 'class': 'edit-proj-box project-goal project-item'})
...
const renderTask = (task) => {
    ...
    const taskPopup = () => {
        const newTask = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "task", id: `${task.title}-id`})
        ...
        const priority = () => {
            ...
            deadline.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.getDeadline(), "MM.dd.yyyy");
            deadlineContent.appendChild(deadline);
        ...
        const goal = () => {
            const goal = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': "task-goal", "id": `${task.title}-goal`});
            const goalHeader = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('h3', {'class': 'goal-button'})
            const goalContent = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('p', {'class': 'goal-content'});
        ...
        const buttonBar = () => {
            ...
            const deleteButton = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'class': 'task-button delete-task', 'id': 'delete-task'})
...
const createMiniTask = (project, task) => {
    ...
    //console.log(task);
    // Delete mini
    const removeMini = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'class': 'mini-button mini-delete', 'value': '-'})
    removeMini.addEventListener('click', () => deleteMini(task));
    // Mark mini as complete
    const finishMini = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'class': 'mini-button mini-finish', 'value': 'F'});
...
module.exports = JSON.parse('{"title":"My Project","description":"Useful information about my project goes here.","priority":2,"toDoCount":0,"goal":"A measurement for success.","deadline":"07/30/2022"}');
...
module.exports = JSON.parse('{"title":"My Task","description":"Useful information about your task goes here.  What specifically are you looking to accomplish?  ","priority":1,"goal":"Your goal, how you decide whether a task is complete.","deadline":"8/12/2022"}');
...
const test = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)("New ggTitle", destDate, 3, "Test Description");
const test2 = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)("Second Task", destDate, 1, "Nothin rly")
//const restProject = Project("PROJECTO", destDate, 2, "Project Scription")
const testProject = (0,_project__WEBPACK_IMPORTED_MODULE_2__.Project)("Project Title", destDate, 2, "PROJECT DESCRIPTION")

const altProject = (0,_project__WEBPACK_IMPORTED_MODULE_2__.Project)();
...
const NEWPROJ = (0,_project__WEBPACK_IMPORTED_MODULE_2__.Project)();
NEWPROJ.tasks.addTask(test);
const newTask = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Task)();



(0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderProject)(NEWPROJ);
