...
const renderProject = (projectObject) => {
    ...
    const priorityButton = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('button', {'class': "priority-button project-item"});
...
module.exports = JSON.parse('{"title":"My Task","description":"Describe task here.","priority":2,"goal":"Create three projects.","deadline":"07/30/2022"}');
...
const testProj = (0,_interface__WEBPACK_IMPORTED_MODULE_3__.renderProject)(testProject);
