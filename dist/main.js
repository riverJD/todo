...
const renderProject = (projectObject) => {
    ...
    const projectButtons = () => {
        ...
        const closeProject = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'image', 'src': _img_arrow_bottom_left_thick_svg__WEBPACK_IMPORTED_MODULE_8__,'class': 'project-button', 'id': 'close-project', 'value': 'Close'});
