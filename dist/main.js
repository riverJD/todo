    ...
    const tasks = () => {
        ...
        const sortMenu = () => {
            ...
            sortButton.addEventListener('click', (e) => {
                ...
                // testing
                _settings__WEBPACK_IMPORTED_MODULE_7__.UI.setSort('deadline');
...
/* harmony import */ var _projectUI__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projectUI */ "./src/projectUI.js");
...
const renderTask = (task) => {
    ...
    // The actual render object 
    const taskPopup = () => {
        const newTask = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {class: "task", id: `${task.title}-${task.getID()}`, 'data-id': task.getID()})

        const title = () => {

            const titleBar = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': "task-title-bar"});
            
            const editButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_pencil_svg__WEBPACK_IMPORTED_MODULE_1__, 'class': 'task-button', 'id': 'task-edit-button', 'value': 'Edit'});
            editButton.addEventListener('click', () => editTask(task));
            titleBar.appendChild(editButton);


            const title = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('h2', {'class': "task-title"});
            title.textContent = task.getTitle();;
            titleBar.appendChild(title);            


            const completeButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_finish_task_svg__WEBPACK_IMPORTED_MODULE_3__, 'class': 'task-button', 'id': 'task-complete-button', 'value': 'CHK'});
            completeButton.addEventListener('click', () => {
                // set task as complete
            })
            titleBar.appendChild(completeButton)

            const priorityIndicator = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': 'display-purpose task-design', 'id': 'task-corner' })
        ...
        const description = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': "task-desc", 'id': `${task.title}-desc`});
        description.textContent = task.getDescription();
                return description;
        }
        ...
        const priority = () => {
            ...
            const priority = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.makeContainer)('task-deadline', _img_calendar_edit_svg__WEBPACK_IMPORTED_MODULE_5__);
            const priorityHeader = priority.querySelector('.task-deadline-header');
           ...
           deadlineButton.addEventListener('click', () => openDeadlineForm(task))
                ...
                priorityHeader.textContent = "Deadline"
            const priorityButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'button', 'class': `priority-button task-item ${priorityStyle(task).priorityValue}`, 'value': priorityStyle(task).priorityText});
            priorityButton.addEventListener('click', () => cyclePriority(task));

            const deadlineContent = priority.querySelector('.task-deadline-content');     
            const deadline = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': "task-deadline task-item", "id": `${task.deadline}-deadline`});
            deadline.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(task.getDeadline(), "MM.dd.yyyy");
            deadlineContent.appendChild(deadline);
        ...
        // Creation of goal element
        const goal = () => {
            const goal = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': "task-goal-header", "id": `${task.title}-goal`});
            const goalHeader = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('h3', {'class': 'goal-title'})
            const goalContent = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('p', {'class': 'task-goal'});
            goalContent.textContent = task.getGoal();
            goalHeader.textContent = "Goal"
            goal.appendChild(goalHeader)
            goal.appendChild(goalContent)
        ...
        const buttonBar = () => {
            ...
            const buttons = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)("div", {'class': 'button-bar', 'id': 'task-buttons'});
            const deleteButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_delete_task_svg__WEBPACK_IMPORTED_MODULE_4__, 'alt': 'Delete task', 'class': 'task-button delete-task', 'id': 'delete-task', 'value': 'Delete'})
            deleteButton.addEventListener('click', (e) => {
                ;(0,_projectUI__WEBPACK_IMPORTED_MODULE_6__.deleteTask)(task);
                closeTask(e.target.parentNode.parentNode);
            });
            buttons.appendChild(deleteButton);
          
            const closeButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_close_project_svg__WEBPACK_IMPORTED_MODULE_0__,'alt': 'Close Task', 'class': 'task-button close-task'});
            closeButton.addEventListener('click', (e) => closeTask(e.target.parentNode.parentNode));
            buttons.appendChild(closeButton);                
...
const changePriority = (task, priority) => {
    ...
    (0,_projectUI__WEBPACK_IMPORTED_MODULE_6__.closeProject)();
    (0,_projectUI__WEBPACK_IMPORTED_MODULE_6__.renderProject)(task.getParent());
    renderTask(task);
...
const createTask = (container, project) => {
    ...
    const task = (0,_todo__WEBPACK_IMPORTED_MODULE_7__.Task)();
    task.setParent(project);
...
const editTask = (task) => {
    ...
    //const project = task.getParent();
    const tempTask = (0,_todo__WEBPACK_IMPORTED_MODULE_7__.Task)();
    ...
    const editButton = document.querySelector('#task-edit-button');
    editButton.classList.add('hidden');
    const saveButton = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_save_task_svg__WEBPACK_IMPORTED_MODULE_2__, 'class': 'task-edit-button task-button', 'id': 'task-edit-button', 'value': 'Save'})
    ...
    const newTitle = (0,_projectUI__WEBPACK_IMPORTED_MODULE_6__.editTitle)('task');
    const newDescription = (0,_projectUI__WEBPACK_IMPORTED_MODULE_6__.editDescription)('task');
    //const newGoal = editGoal('task');
...
const openDeadlineForm = (task) => {
    ...
    const container = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': 'form-container', 'id': 'deadline-form-container'});
...
const updateDeadline = (task, form) => {
    ...
    console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(task.getDeadline(), "yyyy-MM-dd"));
    renderTask(task);
...
const deadlineForm = (task) => {
    ...
    const formContainer = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {"id": "form-container"});
    const form = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('form', {"id": "deadline-form"});

    const dateLabel = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('label', {"for": "date", "class": "form-label", "id": "date-label"});
    dateLabel.textContent = "Date";
    const today = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.getDate)();
    
    const date = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)("input", {"type": "date", "class": "form-input", "name": "date", "id": "form_date", "min": today, 'value': (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(task.getDeadline(), "yyyy-MM-dd"), "required": ""});
    dateLabel.appendChild(date);

    const timeLabel = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('label', {"for": "time", "class": "form-label", "id": "time-label"});
    timeLabel.textContent = "Time";
    const time = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {"type": "time", "class": "form-input", "name": "time", "id": "form_time", 'value': (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(task.getDeadline(), "HH:mm:SS") });
    timeLabel.appendChild(time);

    const buttonBar = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('div', {'class': 'button-bar form-buttons', 'id': 'form-buttons'})
        const submitDeadline = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_save_task_svg__WEBPACK_IMPORTED_MODULE_2__, 'alt': 'confirm deadline', 'class': 'form-button task-button', 'id': 'submit-deadline-button'})
  
        const close = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('input', {'type': 'image', 'src': _img_close_project_svg__WEBPACK_IMPORTED_MODULE_0__, 'alt': 'close without changes', 'class': 'form-button task-button', 'id': 'close-deadline-button'})
            close.addEventListener('click', (e) => {
                const form = document.querySelector("#deadline-form-container")
                e.preventDefault();
                formContainer.remove();
            })
    ;(0,_utils__WEBPACK_IMPORTED_MODULE_8__.appendChildren)(buttonBar, submitDeadline, close)
    
    const repeatOptions = () => {
       
        const chooseRepeat = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('fieldset', {'class': 'fieldset', 'id': 'task-deadline-fieldset'})
        const legend = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)('legend',{"value": 'repeat?'})
        legend.textContent = "Repeat every..."
          
        const none = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.makeRadio)('repeat', 'weekly', `Don't repeat`, true);
        const daily = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.makeRadio) ('repeat', 'weekly', 'Once per day');
        const weekly =  (0,_utils__WEBPACK_IMPORTED_MODULE_8__.makeRadio)('repeat', 'weekly', 'Every week');
        const monthly = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.makeRadio)('repeat', 'monthly', 'Once a month');

        (0,_utils__WEBPACK_IMPORTED_MODULE_8__.appendChildren)(chooseRepeat, legend, none, daily, weekly, monthly);
    ...
    const formHeader = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.element)("h2", {'class':'form-header deadline-form'});
    formHeader.textContent = FORM_HEADER;

   
(0,_utils__WEBPACK_IMPORTED_MODULE_8__.appendChildren)(form, dateLabel, timeLabel, formHeader);
