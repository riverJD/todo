    ...
    const taskPopup = () => {
        ...
        const title = () => {
            ...
            completeButton.addEventListener('click', (e) => {
                ...
                (0,_projectUI__WEBPACK_IMPORTED_MODULE_7__.toggleTaskStatus)(task);
        ...
        const priority = () => {
            ...
            const priority = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.makeContainer)('task-deadline', _img_calendar_edit_svg__WEBPACK_IMPORTED_MODULE_5__);
            const priorityHeader = priority.querySelector('.task-deadline-header');
           ...
           deadlineButton.addEventListener('click', () => openDeadlineForm(task))
                ...
                priorityHeader.textContent = "Deadline"
            const priorityButton = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.element)('input', {'type': 'button', 'class': `priority-button task-item ${priorityStyle(task).priorityValue}`, 'value': priorityStyle(task).priorityText});
            priorityButton.addEventListener('click', () => cyclePriority(task));

            const deadlineContent = priority.querySelector('.task-deadline-content');     
            const deadline = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.element)('div', {'class': "task-deadline task-item", "id": `${task.deadline}-deadline`});
