...
const openDeadlineForm = () => {
    ...
    const container = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('div', {'class': 'form-container', 'id': 'deadline-form-container'});
...
const deadlineForm = () => {
    ...
    const formContainer = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('div', {"id": "form-container"});
    const form = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('form', {"id": "deadline-form"});

    const dateLabel = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('label', {"for": "date", "class": "form-label", "id": "date-label"});
    dateLabel.textContent = "Date";
    const today = new Date(); 
    const date = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)("input", {"type": "date", "class": "form-input", "name": "name", "id": "form_date", "min": today, "required": ""});
    dateLabel.appendChild(date);

    const timeLabel = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('label', {"for": "time", "class": "form-label", "id": "time-label"});
    timeLabel.textContent = "Time";
    const time = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('input', {"type": "time", "class": "form-input", "name": "time", "id": "form_time", "value": "16:00", });
    timeLabel.appendChild(time);

    const buttonBar = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('div', {'class': 'button-bar form-buttons', 'id': 'form-buttons'})
    const repeatOptions = () => {

        
        const legend = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('legend',{"value": 'repeat?'})
        const label = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('label', {'for': "repeat", "class": "form-label", "id": "repeat-label"})
        label.textContent = "repeat options"
        const none = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('input', {'type': 'radio', 'name': 'repeat', 'class': 'form-input radio-repeat', 'id': "repeat-no" })
        const daily = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('input', {'type': 'radio', 'name': 'repeat', 'class': 'form-input radio-repeat', 'id': "repeat-daily" })
        const weekly = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('input', {'type': 'radio', 'name': 'repeat', 'class': 'form-input radio-repeat', 'id': "repeat-weekly" })
        const monthly = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)('input', {'type': 'radio', 'name': 'repeat', 'class': 'form-input radio-repeat', 'id': "repeat-monthly" })

        ;(0,_utils__WEBPACK_IMPORTED_MODULE_7__.appendChildren)(label, none, daily, weekly, monthly);
    ...
    const formHeader = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.element)("h2", {'class':'form-header deadline-form'});
    formHeader.textContent = FORM_HEADER;

   
(0,_utils__WEBPACK_IMPORTED_MODULE_7__.appendChildren)(form, dateLabel, timeLabel, formHeader);
