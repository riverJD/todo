...
const renderTask = (task) => {
    ...
    const taskPopup = () => {
        ...
        const buttonBar = () => {
            ...
            const deleteButton = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.element)('input', {'type': 'image', 'src': _img_delete_task_svg__WEBPACK_IMPORTED_MODULE_4__, 'alt': 'Delete task', 'class': 'task-button delete-task', 'id': 'delete-task', 'value': 'Delete'})
            deleteButton.addEventListener('click', (e) => {
                deletePopup();
            });
            buttons.appendChild(deleteButton);
        ...
        const deletePopup = () => {
            ...
            const confirm = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.element)('input', {'type': 'image', 'src': _img_check_bold_svg__WEBPACK_IMPORTED_MODULE_6__, 'alt': 'confirm delete', 'class': 'task-button popup-item popup-confirm', 'id': 'delete-task-confirm'})
