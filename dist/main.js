    ...
    const deadlineContainer = () => {
        ...
        const container = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': 'card-deadline deadline-container'})
            ...
            const dueDate = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('div', {'class': 'card-due-date'})
                dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(project.content.getDeadline(), 'MM/dd/yy');
...
const getDaysRemaining = (project) => {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((dueDate - today), 'dd') 
...
const createMiniTask = (project, task) => {
    ...
    const miniButton = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.element)('input', {'type': 'button', 'class': 'mini-button', 'value': `${task.getTitle()}`});
...
module.exports = JSON.parse('{"title":"My Project","description":"Useful information about my project goes here.","priority":2,"toDoCount":0,"goal":"A measurement for success.","deadline":"07/30/2022","data-project-id":0}');
